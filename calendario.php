                ...
                <div class="wrapper bg-white rounded shadow w-full ">
                    ...
                    <table class="w-full">
                        ...
                        <tr>
                            ...
                            <th class="p-2 border-r h-10 xl:w-40 lg:w-30 md:w-30 sm:w-20 w-10 xl:text-sm text-xs">
                            <span class="xl:block lg:block md:block sm:block hidden">Miércoles</span>
                            <span class="xl:hidden lg:hidden md:hidden sm:hidden block">Mier</span>
                            </th>
                            <th class="p-2 border-r h-10 xl:w-40 lg:w-30 md:w-30 sm:w-20 w-10 xl:text-sm text-xs">
                        ...
                        <tr class="text-center h-20">
                            <td class="border bg-gray-100 p-1 h-40 xl:w-40 lg:w-30 md:w-30 sm:w-20 w-10 overflow-auto transition cursor-pointer duration-500 ease hover:bg-gray-300">
                              <div class="flex flex-col h-full mx-auto xl:w-40 lg:w-30 md:w-30 sm:w-full w-10 mx-auto">
                            ...
                            <td class="border p-1 xl:w-40 lg:w-30 md:w-30 sm:w-20 w-10 transition cursor-pointer duration-500 ease hover:bg-gray-300">
                            <div class="flex flex-col min-h-[10rem] mx-auto xl:w-40 lg:w-30 md:w-30 sm:w-full w-10 mx-auto overflow-hidden">
                                <div class="top h-5 w-full">
                            ...
                            <td class="border p-1 xl:w-40 lg:w-30 md:w-30 sm:w-20 w-10 transition cursor-pointer duration-500 ease hover:bg-gray-300">
                              <div class="flex flex-col min-h-[10rem] mx-auto xl:w-40 lg:w-30 md:w-30 sm:w-full w-10 mx-auto overflow-hidden">
                                ...
                                <div class="event bg-purple-400 text-white rounded p-1 text-sm mb-1">
                                    ...
                                    <b>Tecnología musical:</b> </br>oportunidades de negocio y desarrollo
                                    </span>
                                    <span class="time">
                                    </br></br><b>09:00 a 11:00 hrs</b>
                                    </span>
                                    <span class="location">
                                    </br></br>Edificio X-7
                                    </span>
                            ...
                            <td class="border p-1 xl:w-40 lg:w-30 md:w-30 sm:w-20 w-10 transition cursor-pointer duration-500 ease hover:bg-gray-300">
                             <div class="flex flex-col min-h-[10rem] mx-auto xl:w-40 lg:w-30 md:w-30 sm:w-full w-10 mx-auto overflow-hidden">
                                ...
                                <div class="bottom flex-grow h-30 py-1 w-full cursor-pointer">
                                    <div class="event bg-purple-400 text-white rounded p-1 text-sm mb-1">
                                    <span class="event-name">
                                    <b>La innovación como estrategia de vida</b>
                                    </span>
                                    <span class="time">
                                    </br></br><b>12:00 hrs</b>
                                    </span>
                                    <span class="location">
                                    </br></br>Edificio Z-1 Coworking
                                    </span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <td class="border p-1 xl:w-40 lg:w-30 md:w-30 sm:w-20 w-10 transition cursor-pointer duration-500 ease hover:bg-gray-300">
                             <div class="flex flex-col min-h-[10rem] mx-auto xl:w-40 lg:w-30 md:w-30 sm:w-full w-10 mx-auto overflow-hidden">
                                ...
                                <div class="bottom flex-grow h-30 py-1 w-full cursor-pointer">
                                    <div class="event bg-purple-400 text-white rounded p-1 text-sm mb-1">
                                    <span class="event-name">
                                    <b>Mentalidad de abundancia:</b> </br>la mentalidad del inversionista
                                    </span>
                                    <span class="time">
                                    </br></br><b>12:00 hrs</b>
                                    </span>
                            ...
                            <td class="border p-1 xl:w-40 lg:w-30 md:w-30 sm:w-20 w-10 transition cursor-pointer duration-500 ease hover:bg-gray-300">
                             <div class="flex flex-col min-h-[10rem] mx-auto xl:w-40 lg:w-30 md:w-30 sm:w-full w-10 mx-auto overflow-hidden">
                                ...
                                <div class="bottom flex-grow h-30 py-1 w-full cursor-pointer">
                                    <div class="event bg-purple-400 text-white rounded p-1 text-sm mb-1">
                                    <span class="event-name">
                                    <b>Cimientos tecnológicos y publicitarios:</b> </br>estrategias fundamentales para el negocio moderno
                                    </span>
                                    <span class="time">
                                    </br></br><b>18:00 hrs</b>
                                    </span>
